...
import {
    ...
    useGetClustersQuery,
    useGetTeamsQuery // Import the hook to get teams
...
export default function Dashboard() {
    ...
    const [teamId, setTeamId] = useState(""); // Default to personal account
    ...
    const handleCreateCluster = async (e) => {
        ...
        // Construct the payload, only include team_id if it's selected
        const payload = {
            name: clusterName,
            ttl_hours: 1
        };
